...
<?
	...
	$mencodigo 	= (isset($_POST['mencodigo']))? trim($_POST['mencodigo']) : 0;

	//--------------------------------------------------------------------------------------------------------------
	$pertipo = VarNullBD($pertipo , 'N');
	$mencodigo = VarNullBD($mencodigo , 'N');
	
	if($pertipo!=0){
		//Elimino el registro
		$query = "DELETE FROM PER_TIPO_MENU WHERE PERTIPO  = $pertipo AND MENCODIGO = $mencodigo ";
