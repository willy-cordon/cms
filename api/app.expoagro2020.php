<?
	...
	define('PathPlano', 'http://app2020.expoagro.com.ar/app/');	
	
	define('mailNameApp', 'EXPOAGRO');
	define('SendMailNombre', 'EXPOAGRO');
	define('SendMailUsuario', 'international@exponenciar.com.ar');
	define('SendMailPass', 'Expo2020');

	//define('SendMailUsuario', 'no_reply@benvidosistemas.com');
	//define('SendMailPass', 'elefanterino');


	define('LinkPlayStore', 'https://play.google.com/store/apps/details?id=com.nextar.expoagro&hl=en_US');
	define('LinkAppStore', 'https://apps.apple.com/mx/app/expoagro-2019/id1351820661');
...
$app->post('/cupones', function()  use ($app){
	...
	try{
		...
		$query = "	SELECT FIRST $cantPagina SKIP $pagina 
					...
					ORDER BY C.CUPTIPO,C.CUPTITULO ";
